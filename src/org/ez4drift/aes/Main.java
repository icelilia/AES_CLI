    ...
    public static void main(String[] args) {
        ...
        if (option.contentEquals("1")) {
            ...
            if (outputFilePath.contentEquals("")) {
                try {
                    AESCore aesCore = new AESCore(key, IV, 1);
                    aesCore.encryptFile(inputFilePath);
                ...
                try {
                    AESCore aesCore = new AESCore(key, IV, 1);
                    aesCore.encryptFile(inputFilePath, outputFilePath);
            ...
            try {
                AESCore aesCore = new AESCore(key, IV, 1);
                aesCore.decryptFile(inputFilePath, outputFilePath);
